...
public class FollowerConstants {
    ...
    private static double xMovement = 73.48812235989197;
    private static double yMovement = 58.36916497622993;
    ...
    public static double forwardZeroPowerAcceleration = -50;
