...
public class FollowerConstants {
    ...
    private static double xMovement = 79.18928479908995;
    private static double yMovement = 60.06134465421544;
    ...
    public static double mass = 10.35;
    ...
    public static double forwardZeroPowerAcceleration = -29.873492165890802; //-29.873492165890802

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -58.67044838518522;
